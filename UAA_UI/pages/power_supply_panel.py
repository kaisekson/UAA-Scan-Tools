...
class ChannelRow(QFrame):
    def __init__(self, ch, drv_ref):
        ...
        self.setStyleSheet("QFrame{background:#16191f;border:1px solid #3a4055;border-radius:6px;}")
        ...
        for attr,label_txt,color in [("v_edit","Set V","#3b82f6"),("i_edit","Set I (A)","#22c55e")]:
            ...
            col.addWidget(lbl(label_txt,"#64748b",9))
            e=QLineEdit("0.00"); e.setFixedWidth(72)
            e.setStyleSheet(f"border-left:2px solid {color};background:#1a1d24;"
    ...
    def _set_style(self,on):
        if on:
            ...
            self.onoff_btn.setStyleSheet(
                ...
                "border-radius:5px;color:#64748b;font-weight:600;}"
...
class SinglePSUWidget(QWidget):
    def __init__(self, index):
        ...
        self.img_lbl.setStyleSheet("background:#16191f;border:1px solid #3a4055;border-radius:6px;color:#64748b;font-size:12px;")
        top.addWidget(self.img_lbl)

        grid=QGridLayout(); grid.setSpacing(8); grid.setColumnStretch(1,1)

        grid.addWidget(lbl("Model","#64748b",10),0,0)
        self.model_cb=QComboBox()
        self.model_cb.addItems(list(MODELS.keys()))
        self.model_cb.setStyleSheet("QComboBox{background:#20242e;border:1px solid #3a4055;border-radius:4px;color:#e2e8f0;padding:5px 8px;font-size:13px;}"
        ...
        grid.addWidget(lbl("Brand","#64748b",10),1,0)
        self.brand_lbl=lbl("Keysight","#94a3b8",12); grid.addWidget(self.brand_lbl,1,1)

        grid.addWidget(lbl("IP Address","#64748b",10),2,0)
        ...
        pt.addWidget(lbl("Timeout (s)","#64748b",10))
        pt.addWidget(self.tmo_edit); pt.addStretch()
        grid.addWidget(lbl("Port","#64748b",10),3,0)
        ...
        self.conn_btn.setStyleSheet("QPushButton{background:#1e2d47;border:1px solid #4a9eff;border-radius:5px;color:#4a9eff;font-size:12px;font-weight:600;padding:0 16px;}"
        ...
        self.remove_btn.setStyleSheet("QPushButton{background:#1a0000;border:1px solid #3d0a0a;border-radius:5px;color:#64748b;font-size:12px;padding:0 12px;}"
        ...
        # Channels
        layout.addWidget(lbl("CHANNELS","#64748b",10,True))
...
class PowerSupplyPanel(QWidget):
    def __init__(self):
        ...
        self.tabs.setStyleSheet("""
            ...
            QTabBar::tab{background:#20242e;color:#64748b;padding:8px 20px;border:1px solid #3a4055;font-size:12px;min-width:80px;}
    ...
    def _add_psu(self):
        ...
        scroll.setStyleSheet("background:#1a1d24;")
