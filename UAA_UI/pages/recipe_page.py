...
class StepRow(QFrame):
    ...
    def __init__(self, idx, step_data):
        ...
        # Action buttons
        up_btn   = _small_btn("↑","#64748b"); up_btn.clicked.connect(lambda: self.move_up.emit(self._idx))
        dn_btn   = _small_btn("↓","#64748b"); dn_btn.clicked.connect(lambda: self.move_down.emit(self._idx))
        ...
        edit_btn.setStyleSheet(
            ...
            "QPushButton:hover{border-color:#eab308;color:#eab308;background:#2e3447;}")
        edit_btn.clicked.connect(self._toggle_expand)
        del_btn  = _small_btn("✕","#64748b")
        del_btn.setStyleSheet(
            "QPushButton{background:#252a38;border:1px solid #3a4055;"
            "border-radius:4px;color:#64748b;font-size:13px;"
            "font-family:'Segoe UI Symbol','Arial Unicode MS',sans-serif;}"
            "QPushButton:hover{border-color:#ef4444;color:#ef4444;background:#2e3447;}")
